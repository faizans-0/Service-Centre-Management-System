...
public class RegistrationGUI extends javax.swing.JFrame {
    ...
    public RegistrationGUI(String success) {
        initComponents();
        f=new JFrame();
        JOptionPane.showMessageDialog(f, "Registration Was Completed Successfully");
    }
    
    public RegistrationGUI(int failure) {
        initComponents();
        g=new JFrame();
        JOptionPane.showMessageDialog(g,"The Passwords Don't Match, Please Try Again","Alert",JOptionPane.WARNING_MESSAGE);
    }
